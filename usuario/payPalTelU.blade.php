...
<input type="hidden" name="hosted_button_id" value="XMPF22FZAMWMA">

<table>

<tr><td><input type="hidden" name="on0" value="consultas telefónicas">consultas telefónicas</td></tr><tr><td><select name="os0">

                <option value="6 consultas telefónicas">6 consultas telefónicas $1,800.00 MXN</option>

                <option value="12 consultas telefónicas">12 consultas telefónicas $3,000.00 MXN</option>

                <option value="18 consultas telefónicas">18 consultas telefónicas $4,000.00 MXN</option>
...
<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
              ...
              <br>
              Una vez realizado su pago favor de notificarnos del mismo enviando un correo a: <a href="mailto:pagos@vazherco.com.mx">pagos&#64;vazherco.com.mx</a>
            </div>
        ...
        <div class="row ">
          <div class="col-md-6 col-md-offset-2 col-sm-6 col-sm-offset-2">
            <div class="well">
              ...
              <br><br>
              Una vez realizado su pago favor de notificarnos del mismo adjuntando su comprovante de pago al siguiente correo: <a href="mailto:pagos@vazherco.com.mx">pagos&#64;vazherco.com.mx</a>
            </div>
        ...
        <div class="row ">
          <div class="col-md-6 col-md-offset-2 col-sm-6 col-sm-offset-2">
            <div class="well">
              ...
              <br><br>
              Una vez realizado su pago favor de notificarnos adjuntando su comprovante de pago al siguiente correo: <a href="mailto:pagos@vazherco.com.mx">pagos&#64;vazherco.com.mx</a>
            </div>
