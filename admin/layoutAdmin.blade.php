...
<head>
  ...
  <meta name="author" content="eSantiago" />
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>{{ HTML::link('admin/cambioAsesores', 'Cuenta asesores') }}</li>
              <li class="divider"></li>
              <li>{{ HTML::link('admin/cambioCA', 'Cambiar contraseña') }}</li>
              <li class="divider"></li>
          ...
          <div>
            ...
            <div class="row"> <!-- Renglon Principal -->
              ...
              <aside class="col-md-2 col-lg-2">
                @include('seccionesVista.adminMenu')
              </aside>

              <div class="col-md-10 col-lg-10">
                @yield('content') <!-- AQUI SE MUESTRA EL CONTENIDO  -->
              </div>
