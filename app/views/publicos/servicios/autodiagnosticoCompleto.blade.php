  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-9">
        ...
        <div class="well trasparenteClaroPlus animacionContenido" id="pnlCheck">
          <div class="row">
            <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1 col-xs-12 col-sm-12">
              ...
              <div class="col-md-8 col-md-offset-2">
                <button id="btnEnviar"  class="btn btn-primary btn-block"><i class="fa fa-paper-plane "></i> Enviar Información</button>
              </div>
...
@section('js')
  {{ HTML::script('js/publicos/servicios/autodiagnosticoCompleto.js') }}
