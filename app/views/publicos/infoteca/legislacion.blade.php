    ...
    <div class="row well transparenteObscuro">
      <div class="row">
        <div class="col-md-12   transladarDerecha" >
          ...
          <button id="titCodigo"      class="btn btn-primary col-md-2"><i class="fa fa-book"></i> Códigos</button>
          <button id="titLeyes"       class="btn btn-primary col-md-1"><i class="fa fa-book"></i> Leyes</button>
