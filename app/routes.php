...
Route::group(array('prefix' => 'publicos/infoteca'), function(){
	...
	Route::get('articulos/articulo8', function(){
		return View::make('publicos.infoteca.articulos.articulo8');
	});
	...
	Route::get('articulos/articulo11', function(){
		return View::make('publicos.infoteca.articulos.articulo11');
	});
