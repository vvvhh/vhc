...
@include('seccionesVista.cabeceraPagina')
    ...
    @include('seccionesVista.barraNavegacionPagina')
        <div class="fondoInfoteca fondo paddingMenu">
            <div class="row">
              <div class="col-lg-12">
                <br>
                <h1 class="tamTitulo grisClaro texto3D tituloEntrada"><i class="fa fa-file-text"></i>  Artículos</h1>
                <br>
              </div>
            </div>
  ...
  <!--  -->     @yield('content') <!-- MUESTRA CONTENIDO DEL ARTICULO DESDE SU BLADE -->
              ...
              <div class="col-md-3 transladarIzquierda">
                @include('seccionesVista.menuArticulo')    <!-- MUESTRA MENU DE ARTICULOS DESDE menuArticulo.blde.php -->
                <br>
