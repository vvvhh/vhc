    ...
    <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="col-md-4">
              <br>
              <img class="img-rounded img-responsive imgN" src="{{URL::asset('img/infoteca/articulos/179537236.jpg')}}"/>
            </div>
        </div>
        ...
        <p class="text-justify">
          Con esas piedras construyó uno de los castillos más emblemáticos de su país, llamado el “Palacio Ideal” (<i>Palais Ideal</i>), el cual llegó a ser admirado por grandes personajes como Pablo Picasso y André Breton.
        </p>

        <p class="text-justify">
          Mucha gente de su comunidad, Châteauneuf-de-Galaure, lo llamaba el <i>tonto del pueblo</i>, porque primero transportó las piedras en sus bolsillos, después en su maleta cuando no traía cartas, luego en cestas y finalmente utilizó una carretilla.
        </p>
        ...
        <p class="text-justify">
          Dicha previsión implica <i>constancia</i>, como la del cartero Cheval, día a día, por lo que para ahorrar, es menester que en un determinado periodo nos comprometamos a destinar una parte de nuestro gasto cotidiano a generar una reserva, y todavía en un plan más ambicioso, aprender a manejar nuestro dinero en inversiones que nos reditúen beneficios en un periodo determinado, para lo cual debemos aprender qué son las inversiones.
        </p>
        ...
        <p class="text-justify">
          Pues bien, aunque suene raro, los fondos de inversión <i> son otra forma de hacer la vaquita.</i>
        </p>

        <p class="text-justify">
          Nuestra legislación define a los fondos de inversión como <i>sociedades anónimas de capital variable que tendrán por objeto exclusivamente la <b>adquisición y venta habitual y profesional</b> de <b>Activos Objeto de Inversión</b> con recursos provenientes de la colocación de las acciones representativas de su capital social ofreciéndolas a persona indeterminada, a través de <b>servicios de intermediación financiera</b>, conforme a lo dispuesto en la Ley del Mercado de Valores y en esta Ley.”</i>
        </p>
        ...
        <p class="text-justify">
          Así que, la próxima vez que pienses en invertir o ahorrar considera hacerlo a través de un fondo de inversión.  Sin duda alguna, será una buena experiencia y una extraordinaria forma de adquirir o modificar tus hábitos de inversión y ahorro: Construye tu <i>Palacio Ideal.</i>
        </p>
