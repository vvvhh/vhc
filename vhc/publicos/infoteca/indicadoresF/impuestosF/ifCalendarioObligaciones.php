...
<div class="col-md-12">
  ...
  <table class="table table-striped  table-bordered table-condensed">
    ...
    <h3 class="text-center">	Obligaciones correspondientes a Noviembre 2016	</h3>
    <thead>
  ...
  <table class="table table-striped  table-bordered table-condensed">
    ...
    <tbody class="animEscalarFila">
        <tr>	<td class="text-center">	Presentar información de las cuentas, los depósitos, servicios, fideicomisos, créditos o préstam​os otorgados a personas físicas y morales, o cualquier tipo de operaciones, para efectos del cobro de créditos fiscales firmes o del procedimiento administrativo de ejecución.
               ...
               </td>	<td class="text-center">	Artículo 32-B, fracción IV del CFF. Regla 2.15.1. de la RMF 2016 y ficha 163/CFF del Anexo 1-A de la RMF 2016.
             </td>	</tr>
        <tr>
    ...
    <table class="table table-striped  table-bordered table-condensed">
      ...
      <tbody class="animEscalarFila">
        ...
        <tr><td class="text-center">	Entero de la retención que se efectúe de pagos por intereses.
          ...
          </td>	<td class="text-center"> Servicio de Declaraciones y Pagos en el caso de las personas obligadas, a utilizar este servicio. Entero de retención: a través de los Bancos autorizados con la línea de captura.
...
<div class="table-responsive">
  <table class="table table-striped  table-bordered table-condensed">
    ...
    <tbody class="animEscalarFila">
      ...
      </td>	<td class="text-center">Esta información se presenta a través de la Declaración Informativa Múltiple del IEPS (MULTI-IEPS) y su Anexo 2.
      ...
      </td>	<td class="text-center"> En el portal de internet del SAT con el programa electrónico Declaración Informativa de Operaciones con Terceros (DIOT).
...
<div class="table-responsive">
  <table class="table table-striped  table-bordered table-condensed">
    ...
    <tbody class="animEscalarFila">
      <tr><td class="text-center">1 y 2</td>	<td class="text-center">18 de noviembre 2016</td>	</tr>
      <tr><td class="text-center">3 y 4</td>	<td class="text-center">21 de noviembre 2016</td>	</tr>
      <tr><td class="text-center">5 y 6</td>	<td class="text-center">22 de noviembre 2016</td>	</tr>
      <tr><td class="text-center">7 y 8</td>	<td class="text-center">23 de noviembre 2016</td>	</tr>
      <tr><td class="text-center">9 y 0</td>	<td class="text-center">24 de noviembre 2016 </td>	</tr>
    </tbody>
  </table>
</div>
<!-- **************** -->
...
<h4 class="text-center">
PRESENTAR LOS SIGUIENTES PAGOS O DECLARACIONES A MAS TARDAR EL DIA 30
</h4>
<h4 class="text-center">
...
<table class="table table-striped  table-bordered table-condensed">
  ...
  <tbody class="animEscalarFila">
    <tr><td class="text-center">Presentar la relación de las personas a las que en el trimestre anterior les hubiere trasladado el IEPS en forma expresa y por separado.
     </td>	<td class="text-center">Personas morales y físicas que trasladen en forma expresa y por separado el IEPS
     </td>	<td class="text-center">Esta información se presenta a través de la Declaración Informativa Múltiple del IEPS (MULTI-IEPS) y su Anexo 1.​
     </td>  <td class="text-center">Artículo 19, fracción II de la LIEPS. Regla 5.2.2. de la RMF 2016.
     </td>	</tr>
  </tbody>
</table>
</div>
...
<br><br>
<h4 class="text-center">
Pago bimestral definitivo del ISR, IEPS e IVA - Régimen de Incorporación Fiscal
</h4>
<div class="table-responsive">
<table class="table table-striped  table-bordered table-condensed">
  <thead>
  ...
  <tbody class="animEscalarFila">
    <tr><td class="text-center">	Presentar Pago definitivo del ISR, IEPS e IVA correspondiente al bimestre septiembre-octubre del ejercicio 2016. Este pago se presenta dentro del mes siguiente al que corresponda el bimestre. </td>
        <td class="text-center">	Personas físicas. Régimen de Incorporación Fiscal	</td>
        <td class="text-center">	Aplicativo Mis Cuentas  <br> Servicio de Declaraciones y Pagos que podrán utilizar los contribuyentes del Régimen de Incorporación Fiscal que en 2013 hubieran tributado en el Régimen Intermedio o en el Régimen de las actividades empresariales y profesionales.  <br> Pago con línea de captura en los Bancos autorizados.</td>
        <td class="text-center">	Artículos 111, quinto párrafo y 112, fracción VI de la LISR, 5-E de la LIVA y 5-D de la LIEPS. Regla 2.9.2. de la RMF 2016
        </td> </tr>
