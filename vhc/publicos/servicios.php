...
<html lang="es">
  ...
  <head>
    ...
    <title>  Servicios | Vázquez Hernández Contadores, S. C.</title>
          ...
          <div class="intro-table intro-table-hover efecto1">
            <div class="dmask fondoD1">
    						<div class="bottom">
    							  ...
    							  <a href="servicios/contables.php" class="btn btn-md fondoAzulClaro expand"><strong>Ver más</strong></a>
            ...
            <div class="intro-table intro-table-hover efecto2">
              <div class="dmask fondoD1">
                  <div class="bottom">
                      ...
                      <a href="servicios/asesoria.php" class="btn btn-md fondoAzulClaro expand"><strong>Ver más</strong></a>
                  </div>
               </div>
            </div>
          </div>
              ...
              <div class="intro-table intro-table-hover efecto3">
                <div class="dmask fondoD1">
                    <div class="bottom">
                        ...
                        <a href="servicios/auditoria.php" class="btn btn-md fondoAzulClaro expand"><strong>Ver más</strong></a>
                    </div>
                </div>
              </div>
            </div>
             ...
             <div class="intro-table intro-table-hover efecto4">
                <div class="dmask fondoD1">
                   <div class="bottom">
                       ...
                       <a href="servicios/juridico.php" class="btn btn-md fondoAzulClaro expand"><strong>Ver más</strong></a>
                   </div>
                 </div>
              </div>
            </div>
                ...
                <div class="intro-table intro-table-hover efecto5">
                    <div class="dmask fondoD1">
                      <div class="bottom">
                          ...
                          <a href="servicios/fiscal.php" class="btn btn-md fondoAzulClaro expand"><strong>Ver más</strong></a>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="intro-table intro-table-hover efecto6">
                      <div class="dmask fondoD1">
                        <div class="bottom">
                            ...
                            <a href="servicios/pLavado.php" class="btn btn-md fondoAzulClaro expand btnPld"><strong>Ver más</strong></a>
                        </div>
                      </div>
                  </div>
                </div>
        ...
        <div class="intro-table intro-table-hover efecto8">
              ...
              <div class="bottom">
                <div class="dmask fondoD1">
                  ...
                  <a href="servicios/auditoriaG.php" class="btn btn-lg btn-success expand">Ver más</a>
                </div>
              </div>
            </div>
      </div>
          ...
          <div class="intro-table intro-table-hover efecto7">
                ...
                <div class="bottom">
                  <div class="dmask fondoD1">
                    ...
                    <a href="servicios/laborales.php" class="btn btn-md fondoAzulClaro expand"><strong>Ver más</strong></a>
                  </div>
                </div>
              </div>
        </div>
          ...
          <div class="intro-table intro-table-hover efecto9">
                ...
                <div class="bottom">
                  <div class="dmask fondoD1">
                    ...
                    <a href="servicios/otros.php" class="btn btn-md fondoAzulClaro expand"><strong>Ver más</strong></a>
                  </div>
                </div>
              </div>
