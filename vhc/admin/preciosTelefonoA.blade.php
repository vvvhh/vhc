...
@section('content')
<h1><span class=" glyphicon glyphicon-earphone text-primary"></span> Precios de los paquetes Telefónicos</h1>
          ...
          <div class="form-horizontal">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" id="txtEditPrecio" class="form-control input-sm" placeholder="cantidad" autofocus>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" id="txtEditNum" class="form-control input-sm" placeholder="cantidad" autofocus>
                </div>
              </div>
...
@section('js')
{{HTML::script('js/admin/preciosTelefonoA.js')}}
@stop

@section('javascript')
  <script>
    $('#collapsePrecios').addClass('in');
    $('#liPTelefonicas').addClass('activoBorde');
  </script>
@stop
