...
<div class="well transparenteClaroMTxt">  <!-- Well Articulo1 -->
  <div class="row">
    <div class="col-md-12">
        ...
        <!-- CONTENIDO DEL ARTICULO -->
        <h3>La importancia de los impuestos</h3>
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="col-md-4">
              <br>
              <img class="img-rounded img-responsive imgN" src="../../../img/infoteca/resenas/87158796.jpg"/>
            </div>
        </div>
        ...
        <br><br>
        <p class="text-justify">
          Dos de los principios cuyos significados son de los más importantes para el sistema tributario se mencionan a continuación: <strong>proporcionalidad</strong> y <strong>equidad</strong>.
        </p>
        ...
        <p class="text-justify">
          Simplemente teclea en Google o en el buscador de tu preferencia “SCJN” y se desplegará la página de la Suprema Corte, en uno de sus rubros dice “consulta tradicional” si le das <i>click</i>, acto seguido, aparecerá una pantalla, en donde verás muchos cuadros, pero no te preocupes, habrá un espacio en blanco donde podrás escribir “principio de proporcionalidad” o “equidad tributaria” y se desplegará toda la información que nuestro máximo tribunal haya emitido.
        </p>
