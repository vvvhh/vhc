...
<div class="table-responsive">
    ...
    <!-- **************** -->
<h3 class="text-center">	 Tarifa opcional aplicable para el cálculo del pago provisional correspondiente al primer semestre de 2017, que efectúen los contribuyentes que cumplan con sus obligaciones fiscales en los términos del Capítulo VIII del Título II de la Ley del Impuesto sobre la Renta.	</h3>											
...
<div class="table-responsive">
      <table class="table table-striped  table-bordered table-condensed">
    <!-- ****************** -->
    <h3 class="text-center">	Tarifa opcional aplicable para el cálculo del pago provisional correspondiente al segundo semestre de 2017, que efectúen los contribuyentes que cumplan con sus obligaciones en los términos del Capítulo VIII del Título II de la Ley del Impuesto sobre la Renta.	</h3>											
