...
<div class="col-md-12">
  ...
  <table class="table table-striped  table-bordered table-condensed">
    ...
    <h3 class="text-center">	Obligaciones correspondientes a Diciembre 2016	</h3>
    <thead>
    ...
    <tbody class="animEscalarFila">
      ...
      <tr><td class="text-center">
        Pago provisional del ISR, IVA, IEPS y entero de retenciones.
         ...
         Con el Servicio de Declaraciones y Pagos.  Pago con línea de captura en los Bancos autorizados.
       </td>  <td class="text-center">
         Artículos 10, 12, 14, 71, 72, 74, 75, 84, 87, 96 y 106 de la LISR. Artículos 1-A y 5-D de la LIVA. Regla 2.8.5.1 de la RMF 2016.
       </td>	</tr>

       <tr><td class="text-center">
         Pago provisional o definitivo del ISR, IVA, IEPS y entero de retenciones, en su caso.
      </td>	<td class="text-center">
        Personas fisicas: <br> Actividades Empresariales y Servicios Profesionales. Arrendamiento de bienes inmuebles Salarios, en su caso, sólo ISR.
      </td>	<td class="text-center">
        Con el Servicio de Declaraciones y Pagos. Pago con línea de captura en los Bancos autorizados.
      </td><td class="text-center">
  ...
  <tbody class="animEscalarFila">
    <tr><td class="text-center">
      Presentar información sobre pago, retención, acreditamiento y traslado del IVA en las operaciones con los proveedores.
       ...
       Artículo 32 fracciones V y VIII de la LIVA. Reglas 4.5.1 y 4.5.2 de la RMF 2016.
     </td>	</tr>
  </tbody>
</table>
<!-- /******************************************************************************************************************************* -->
