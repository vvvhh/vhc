...
@section('title')
  Registro | Vázquez Hernández Contadores, S. C.
@stop
...
<div style="background-image:url('../../../img/inicio/491207279.jpg ');"class="fondo paddingTexto">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="tituloEntrada tamTitulo grisClaro "><i class="fa fa-tty"></i> Sección de registro</h1>
      </div>
    </div>
        ...
        <div name="sentMessage" >  <!-- Formulario -->
          ...
          <div id="formCampos" class="form-horizontal hidden" data-toggle="validator" >
            <div id="nombreMoral" class="form-group hidden">
              ...
              <div class="col-md-8">
                <input id="txtNombreMoral" type="text" class="form-control" placeholder="*Persona moral" maxlength="120">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input id="txtNombre" type="text" class="form-control"   placeholder="*Nombre y apellidos" maxlength="120">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input id="txtGiro" type="text" class="form-control"   placeholder="*Actividad económica" maxlength="50">
              </div>
            </div>
            ...
            <div id="labelFecha" class="text-center">
              <label >Fecha en que se otorgo el número de Escritura Publica</label>
            </div>
          ...
          <div>
            <input type="hidden" name="contratarh" id="contratarh" value="<?php echo csrf_token(); ?>">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
          </div>

          <div class="col-md-5 col-md-offset-4 ">
            <button id="btnContratar" type="submit" class="btn btn-primary btn-block hidden" href=""><i class="fa fa-send"></i> Realizar Regitro</button>
          </div>
...
@section('js')
{{ HTML::script('js/publicos/servicios/asesoriaServ/registroContratar.js') }}
