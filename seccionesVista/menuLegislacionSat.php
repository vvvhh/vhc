          ...
          <div class="panel panel-default">
            ...
            <div id="ulCo" class="panel-collapse collapse">
              ...
              <ul  class="colorNav liInfoteca" style="list-style-type: none">
                ...
                <li id="li7Resolucion16li" class="liInfoteca">
                      <a class="grisClaro " id="li7Resolucion16"  style="cursor:pointer">
                           <p>
                             - Anexo 1-A de la Resolución Miscelánea Fiscal para 2017 anticipada
                           </p>
                      </a>
                </li>
                <li id="li7Resolucion15li" class="liInfoteca">
                      <a class="grisClaro " id="li7Resolucion15"  style="cursor:pointer">
                           <p>
                             - Resolución Miscelánea Fiscal para 2016 (Actualizada a la Quinta Resolución de Modificaciones a la Resolución Miscelánea Fiscal para 2016 y sus anexos 1, 1-A, 23 y 25-Bis del 1 de diciembre de 2016)
                           </p>
                      </a>
                </li>

              <ul  class="colorNav liInfoteca" style="list-style-type: none">
                <li id="li7Resolucion14li" class="liInfoteca">
                      <a class="grisClaro " id="li7Resolucion14"  style="cursor:pointer">
                           <p>
                             - Quinta Resolución de Modificaciones a la Resolución Miscelánea Fiscal para 2016 y sus anexos 1, 1-A, 15, 23 y 25-Bis. - Publicada el 1 de diciembre de 2016
                           </p>
                      </a>
                </li>
                <li id="li7Resolucion13li" class="liInfoteca">
                      <a class="grisClaro " id="li7Resolucion13"  style="cursor:pointer">
                           <p>
                             - Resolución de Modificaciones a la Resolución Miscelánea Fiscal para 2016. Actualizada con la 1ra, 2da, 3ra y 4ta Resolución de Modificaciones. - Publicadas en el DOF el 1 de abril, 6 de mayo, 14 de julio y 4 de octubre de 2016
                           </p>
                      </a>
                </li>
