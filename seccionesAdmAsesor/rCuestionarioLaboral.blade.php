    ...
    <div class="row hidden" id="pnlDetalles">
        ...
        <div class="col-lg-12">
            ...
            <ul id="myTab" class="nav nav-tabs nav-justified">
                <li class="active"><a href="#service-one" data-toggle="tab"><strong> Condiciones generales de trabajo </strong></a>
                </li>
                     ...
                     <div class="col-md-12">
                       <div class="table-responsive" id="tblCapacitacion">
                         <table class="table table-striped table-bordered table-hover">
                           <thead>
                            <!--   <tr class="tablaAdm">
                               <th colspan="3" class="text-center"> Capacitación y Adiestramiento</th>
                             </tr> -->
                             <tr class="tablaAdm">
                               <td class="col-md-1 text-center">N</td>
                               <td class="col-md-9 text-center">Pregunta</td>
                     ...
                     <div class="col-md-12">
                       <div class="table-responsive" id="tblSeguridad">
                         <table class="table table-striped table-bordered table-hover">
                           <thead>
                          <!--     <tr class="tablaAdm">
                               <th colspan="3" class="text-center"> Seguridad e higiene</th>
                             </tr> -->
                             <tr class="tablaAdm">
                               <td class="col-md-1 text-center">N</td>
                               <td class="col-md-9 text-center">Pregunta</td>
